<?php
	...
	if(isset($_POST['contact_name'])&&isset($_POST['email'])&&isset($_POST['subject'])&&isset($_POST['msg']))
	{
	
		$contact_name=$_POST['contact_name'];$email=$_POST['email'];$subject=$_POST['subject'];$msg=$_POST['msg'];
		if(!empty($contact_name)&&!empty($email)&&!empty($subject)&&!empty($msg))
		{
                        $eid="rlbagad2@gmail.com";
	                $subject=" ";
				...
				<div class="collapse navbar-collapse" id="myNavbar">
				  ...
				  <?php if(!loggedin())
					...
					<?php
                                        ...
                                        <li class="active"><a href="contactus.php"><span class="glyphicon glyphicon-phone-alt"></span> Contact us</a></li>
...
<br><br>
<div class="container">
<center><div class="col-xs-12" style="font-family:'Lobster' ,cursive;color:blue;background-color:light-blue;"><h1>For any query,suggestion or feedback please contact us at</h1></div></center>
<br><br>

<center>
  <h4>Rahul Bagad</h4>
  <h5><span class="glyphicon glyphicon-earphone"></span>  7350617969</h5>
  <h5><span class="glyphicon glyphicon-envelope"></span>  rlbagad2@gmail.com</h5>
...
<center>
<div class="col-sm-6">
  <h4>Savyasachi Dhurve</h4>
  <h5><span class="glyphicon glyphicon-earphone"></span>  9049385853</h5>
  <h5><span class="glyphicon glyphicon-envelope"></span>  savya1612@gmail.com</h5>
</div>
</center>
<br>
<center>
<div class="col-sm-6">
  <h4>Sankalp Yerawar</h4>
  <h5><span class="glyphicon glyphicon-earphone"></span>  8237669414</h5>
  <h5><span class="glyphicon glyphicon-envelope"></span>  sankalpyerawar@gmail.com</h5>
</div>
</center>
</div>
<br><br><br><br>
